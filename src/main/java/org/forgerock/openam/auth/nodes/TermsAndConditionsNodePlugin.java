...
public class TermsAndConditionsNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(TermsAndConditionsNodePlugin.currentVersion, 
				Collections.singletonList(TermsAndConditionsNode.class));
	}
	...
	public void upgrade(String fromVersion) throws PluginException {
	  pluginTools.upgradeAuthNode(TermsAndConditionsNode.class);
	}
	...
	public String getPluginVersion() {
		return TermsAndConditionsNodePlugin.currentVersion;
	}
}
